...
package com.aranaira.ascpath.client.models;
...
@OnlyIn(Dist.CLIENT)
public class LibeerianModel extends EntityModel<Entity> {
	...
	public LibeerianModel() {
		...
		body.setTextureOffset(41, 63).addBox(-3.0F, 0.5F, -5.5F, 6.0F, 1.0F, 0.0F, 0.0F, false);
		body.setTextureOffset(32, 48).addBox(-4.0F, -6.5F, -5.5F, 8.0F, 3.0F, 8.0F, 0.0F, false);
		body.setTextureOffset(41, 60).addBox(-3.0F, -3.5F, -5.5F, 2.0F, 1.0F, 0.0F, 0.0F, false);
		body.setTextureOffset(0, 56).addBox(3.0F, 1.0F, -3.0F, 2.0F, 3.0F, 5.0F, 0.0F, false);
		body.setTextureOffset(0, 51).addBox(-5.0F, 1.0F, -3.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		body.setTextureOffset(0, 51).addBox(-5.0F, 1.0F, 0.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
